...
<OverlayScrollbarsComponent style="width: 100%">
	<div class="wrapper">
		<div class="buttons">
			<Button size="sm" hierarchy="primary" text="primary" />
			<Button size="md" hierarchy="primary" text="primary" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="secondary-gray" text="secondary-gray" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="secondary-color" text="secondary-color" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="tertiary-gray" text="tertiary-gray" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="tertiary-color" text="tertiary-color" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="link-gray" text="link-gray" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="link-color" text="link-color" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="primary-destructive" text="primary-destructive" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="secondary-destructive" text="secondary-destructive" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="tertiary-destructive" text="tertiary-destructive" />
		...
		<div class="buttons">
			...
			<Button size="md" hierarchy="link-destructive" text="link-destructive" />
...
<style lang="scss">
	.wrapper {
		display: flex;
		padding: 32px var(--spacing-none, 0px) var(--spacing-6xl, 48px) var(--spacing-none, 0px);
